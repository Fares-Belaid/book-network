...
public class EmailService {
    ...
    public void sendEmail(String to, String username, EmailTemplateName emailTemplateName,
                          String confiramtionURL, String activationCode, String subject) throws MessagingException {
        // send email
        String templateName;
        ...
        properties.put("confirmationURL", confiramtionURL);
        properties.put("activationCode", activationCode);

        Context context = new Context();
        context.setVariables(properties);
        helper.setFrom("belaid.fares1995@gmail.com");
        helper.setTo(to);
